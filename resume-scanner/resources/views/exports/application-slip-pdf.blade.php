...
<body>
    @include('exports.partials.document-header', ['title' => 'Application Slip'])
    ...
    <div class="note">
        <p>This slip confirms that the above application was successfully submitted through the recruitment system.</p>
